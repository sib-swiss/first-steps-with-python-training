...
# **1.** Create a new record by **slicing** the previous record using the coordinates of the 'S' gene.
...
#**2.** Translate the 'S' gene (transcript in this case, as this is an RNA virus) into a new variable called `s_protein`.
